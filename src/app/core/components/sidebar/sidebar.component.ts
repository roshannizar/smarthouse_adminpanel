...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/garbage', title: 'Garbage', icon: 'delete', class: ''},
  { path: '/rent', title: 'Rent', icon: 'key', class: ''},
  { path: '/waterBill', title: 'Water Bill', icon: 'key', class: ''},
  { path: '/utility', title: 'Utility', icon: 'key', class: ''},
